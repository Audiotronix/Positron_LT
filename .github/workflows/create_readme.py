...
mechanical_table = ''
mechanical_header = '|'+pad_column('Part Name', mechanical_column_lengths['cad_name'], 2.5)+'| Link | Alt Link |'+pad_column('Amount', mechanical_column_lengths['amount'])+'|'+pad_column(

...
printed_table = ''
printed_header = '|'+' '*int((longest_printed_name-8)/2)*4+'Part Name'+' '*int((longest_printed_name-8)/2)*4+'| STL | STEP | Amount | Print Time | Weight (g)|\n| :---: | --- | --- | --- | --- | --- |\n'
mechanical_table = ''
mechanical_header = '|'+' '*int((longest_printed_name-8)/2)*4+'Part Name'+' '*int((longest_printed_name-8)/2)*4+'| Link | Alt Link | Amount | Price | Note |\n| :---: | --- | --- | --- | --- | --- |\n'

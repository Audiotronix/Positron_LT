...
mechanical_header = '|'+pad_column('Part Name', column_lengths['mechanical']['cad_name'], 2.4)+'|'+pad_column('CAD Amount', column_lengths['mechanical']['amount'])+'| '+pad_column('Link', column_lengths['mechanical']['link'])+' |'+pad_column('Price', column_lengths['mechanical']['price'], 2)+'|'+pad_column('PCS', column_lengths['mechanical']['pcs'])+'|'+pad_column('Note', column_lengths['mechanical']['note'])+'|\n| --- | --- | --- | --- | --- | --- |\n'
